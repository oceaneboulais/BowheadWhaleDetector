...
\subsection{\label{sec:EventDetection}Event Detection}
...
\subsection{\label{sec:DatasetEditing}Dataset editing}
...
from the original CFAR detection pipeline (Sec.~\ref{sec:EventDetection}).
...
initialization on this dataset.
